...
def preprocess_dataframe(df):
    ...
    df = df[(df['quiz_answers1'].isin(['Россия', 'Израиль', 'Юго-Восточная Азия', 'Латинская Америка',
                                  'Северная Америка', 'СНГ', 'Европа', 'Другое', 'Южная Корея',
                                  'ОАЭ', 'Австралия'])) &
       (df['quiz_answers2'].isin(['23 - 30', '25 - 30', '30 - 40', '40 - 50', '50 - 60',
                                  '41 - 50', '31 - 40', '26 - 30', 'до 18 лет',
                                  '18 - 25', '51 - 60', '18 - 23', '60 +', '24 - 30'])) &
       (df['quiz_answers3'].isin(['Гуманитарий (общение с людьми, искусство, медицина и т.д.)',
                                  'IT сфера (разработчик, тестировщик, администратор и т.п.)', 'Школьник, студент',
                                  'Другое', 'Предприниматель, руководитель', 'Пенсионер',
                                  'Профессии связанные с числами (аналитик, бухгалтер, инженер и т.п.)',

                                  'Декрет', 'Преподаватель, учитель'])) &
       (df['quiz_answers4'].isin(['до 30 000 руб.', 'более 100 000 руб.', 'до 100 000 руб.', '0 руб.', 'до 60 000 руб.',
                                  'более 100 000 руб. / более $1400', 'до 60 000 руб. / до $800', '0руб.',
                                  '0 руб./ $0', 'до 100 000 руб. / до $1400', 'до 30 000 руб. / до $400'])) &
       (df['quiz_answers5'].isin(['Да, если я точно найду работу после обучения.',
                                  'Нет. Хочу получить только бесплатные материалы.',
                                  'Да, если это поможет мне в реализации проекта.'])) &
       (df['quiz_answers6'].isin(['до 10 часов в неделю',
                                  'до 5 часов в неделю',
