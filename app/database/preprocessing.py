...
def preprocess_dataframe(df):
    ...
    df = df[(df['quiz_answers1'].isin(['Россия', 'Израиль', 'Юго-Восточная Азия', 'Латинская Америка',
                                  ...
                                  'ОАЭ', 'Австралия'])) &
       (df['quiz_answers2'].isin(['41 - 50', '31 - 40', '26 - 30', 'до 18 лет',
       ...
       (df['quiz_answers4'].isin(['до 30 000 руб.',
                                  'более 100 000 руб.', 'до 100 000 руб.', '0 руб.', 'до 60 000 руб.',
                                  'более 100 000 руб. / более $1400', 'до 60 000 руб. / до $800',
