...
app.add_url_rule(
    "/s3-upload",
    view_func=views_services.S3UploadView.as_view("s3_upload"),
)
app.add_url_rule(
    "/api/s3-upload",
    view_func=views_services.ApiS3UploadView.as_view("api_s3_upload"),
)
...
from app.ats.preparData import filter_numbers, filter_openers, filter_delete
...
app.add_url_rule(
    "/callsopenernumber", view_func=callsOpenerNumber.as_view("calls_openernumber")
)
app.add_url_rule(
    "/callsopenerhours", view_func=callsOpnerHour.as_view("calls_openerhour")
)
