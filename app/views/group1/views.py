...
from app.utils import (
    ...
    clusters_calculate,
    landings_calculate,
    traffic_sources_calculate,
    segments_stats_calculate,
    leads_ta_stats_calculate,
)
...
class TrafficSourcesView(FormView):
    template_name = "group1/traffic-sources/index.html"
    title = "Источники трафика"
    form_class = forms.TrafficSourcesForm
    ...
    def form_valid(self):
        ...
        if date_start or date_end:
            ...
            if len(table) == 0:
                ...
                tables = traffic_sources_calculate(table)

        else:
            tables = pickle_app.load("traffic_sources")
...
class SegmentsStatsView(FormView):
    template_name = "group1/segments-stats/index.html"
    title = "Сегменты статистика"
    form_class = forms.SegmentsStatsForm
    ...
    def form_valid(self):
        ...
        if date_start or date_end:
            ...
            if len(table) == 0:
                ...
                tables = segments_stats_calculate(table)

        else:
            tables = pickle_app.load("segments_stats")
...
class LeadsTAStatsView(FormView):
    template_name = "group1/leads-ta-stats/index.html"
    title = "Лиды по ЦА статистика"
    form_class = forms.LeadsTAStatsForm
    ...
    def form_valid(self):
        ...
        if date_start or date_end:
            ...
            if len(table) == 0:
                ...
                tables = leads_ta_stats_calculate(table)

        else:
            tables = pickle_app.load("leads_ta_stats")
