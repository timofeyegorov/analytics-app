...
from database import get_ta_filters, get_ta_filter, add_ta_filter, edit_ta_filter
...
def segments():
    ...
    return render_template('segments.html', ta_filters=ta_filters, filter=ta_filter, tables=tables, date_start=date_start, date_end=date_end)
